    ...
    <b-card no-body header-bg-variant="light">
      <template v-slot:header>
        <div>
          ...
          <router-link v-if="permission('administrativos.create')" :to="{path: '/gestiones/administrativos/nuevo'}">
            <button
              type="button"
...
<script>
  ...
  import GridGeneral from '../../components/administrativo/GridGeneral'
